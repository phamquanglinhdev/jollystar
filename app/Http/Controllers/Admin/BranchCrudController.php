...
class BranchCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('Chi nhánh', 'Các chi nhánh');
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('code')->label("Mã chi nhánh (duy nhất)");
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('name')->label("Tên chi nhánh");
        CRUD::field('code')->label("Mã chi nhánh (duy nhất)");
