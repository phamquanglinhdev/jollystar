...
/**
 * Class BagCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class BagCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Bag::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/bag');
        CRUD::setEntityNameStrings('Menu sách', 'Menu sách');
    }
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('opacity')->label("Độ phủ tối (0->1)");
